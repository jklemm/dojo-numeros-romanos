...
class ConverteParaNumerosRomanosTests(TestCase):
    ...
    def test_todos_os_milhares(self):
        ...
        self.assertEquals('IV^', self.conversor.converter(4000))
        self.assertEquals('V^', self.conversor.converter(5000))
        self.assertEquals('VI^', self.conversor.converter(6000))
        self.assertEquals('VII^', self.conversor.converter(7000))
        self.assertEquals('VIII^', self.conversor.converter(8000))
        self.assertEquals('IX^', self.conversor.converter(9000))
    ...
    def test_todos_misturados(self):
        ...
        self.assertEquals('IV^DLXVII', self.conversor.converter(4567))
        self.assertEquals('V^DCLXXVIII', self.conversor.converter(5678))
        self.assertEquals('VI^DCCLXXXIX', self.conversor.converter(6789))
        self.assertEquals('VII^DCCCXC', self.conversor.converter(7890))
        self.assertEquals('VIII^CMI', self.conversor.converter(8901))
        self.assertEquals('IX^XII', self.conversor.converter(9012))
        self.assertEquals('IX^CMXCIX', self.conversor.converter(9999))
